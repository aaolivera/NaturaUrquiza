...
namespace NaturaUrquiza.Helpers
{
    public static class IconContainerHelper
    {
        public static MvcHtmlString IconContainer(this HtmlHelper html, ListaPaginada<ProductoDto> items)
        {
            ...
            var celdas = 0;
            var htmlstring = "<div class='content-wrapper'>";
            foreach (var entidad in items)
            {
                ...
                htmlstring += @"<div class='col-lg-4'>
                                  ...
                                  <p class='text-center'><a class='btn btn-default btn-xs ajax-ver-link' href='" + urlHelper.Action("Ver", "Natura", new { id = entidad.Id }) + @"' role='button'><os-p>detalles</os-p></a></p>
                                </div>";
            ...
            {
                htmlstring += "<div class='content-wrapper text-center'>";
